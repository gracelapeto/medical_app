...
public class Main {
    public static void main(String[] args) {
        ...
        PrescriptionStatisticDao prescriptionStatisticDao = new PrescriptionStatisticDao(session);
...
//            patient.setContactInfo("355682345678");
...
//            }
            ...
            PrescriptionDao prescriptionDao = new PrescriptionDao(session,appointmentDao);
            ...
            prescriptionDao.issuePrescription(prescription, 1L);
            System.out.println(prescriptionStatisticDao.getMostPrescribedMedicines());
//
